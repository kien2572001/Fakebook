...
export default function Profile({ userData, thisProfileUser }) {
  ...
  const [tab, setTab] = useState("about"); // about, photos, friends
  ...
  return (
    <div className="mini-desktop:mx-32">
        ...
        <div className="absolute bottom-0 w-full h-14 border-t-[1px] flex items-center">
          <div className=" flex items-center w-full justify-around">
            ...
            <span
              className={
                "text-sm cursor-pointer font-semibold " +
                (tab === "photos" ? "text-blue-500" : "text-gray-400")
              }
            ...
            <span
              className={
                "text-sm cursor-pointer font-semibold " +
                (tab === "friends" ? "text-blue-500" : "text-gray-400")
              }
      ...
      {/* Profile body */}
      {tab === "about" ? (
        <About thisProfileUser={thisProfileUser} setTab={setTab} />
      ) : tab === "photos" ? (
        <Photos thisProfileUser={thisProfileUser} setTab={setTab} />
      ) : tab === "friends" ? (
        <Friends thisProfileUser={thisProfileUser} setTab={setTab} />
      ) : (
        <></>
      )}
    </div>
