...
function login() {
  ...
  return (
    <div className="w-full h-screen laptop:grid laptop:grid-cols-12 relative">
      <img src={LoginBackground.src} alt="avatar" className="absolute hidden laptop:inline-block scale-105" />
      {/* Left block */}
      <div className="hidden laptop:block laptop:col-span-5 h-screen  overflow-x-hidden">
