...
export default function Index() {
  ...
  return (
    <MainLayout>
      <div className="mx-32">
        <div className="py-4 my-2 h-[436px] rounded-2xl bg-white relative drop-shadow-md">
          ...
          <div className="flex relative px-4">
            ...
            <div className="ml-36 mt-4 flex w-full justify-between">
              <div>
                <p className="font-bold text-xl">Mohannad Zitoun</p>
                <p className="text-sm text-gray-400 font-medium">
                  support@gmail.com
                </p>
              </div>
              <div className="flex items-center">
                <button className="bg-[#10D876] h-[50px] text-white px-4 py-2 rounded-md font-semibold text-sm mr-2">
                  Add friend
                </button>
          ...
          <div className="absolute bottom-0 w-full h-14 border-t-[1px] flex items-center">
            <span
              className="text-sm cursor-pointer font-semibold px-6 
            after:content-[''] after:absolute after:bottom-0 after:left-6 after:h-[2px] after:w-12 after:bg-black"
            >
              About
            </span>
            <span className="text-sm cursor-pointer font-semibold px-6 text-gray-400">
              Membership
            </span>
            <span className="text-sm cursor-pointer font-semibold px-6 text-gray-400">
              Discussion
          ...
          <div className="basis-1/3 mr-4">
            <div className="py-6 rounded-xl bg-white shadow-md mb-4">
              ...
              <div className="flex items-center px-4 mb-6">
                ...
                <div>
                  <p className="font-bold text-sm">Flodia, Austia</p>
                </div>
              </div>
              <div className="flex items-center px-4 mb-4">
